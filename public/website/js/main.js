...
(function ($) {
  ...
  var Porto = {
    ...
    filterSlider: function () {
      ...
      lower  = document.getElementById('noUi-handle-lower'),
      upper  = document.getElementById('noUi-handle-upper'),
          currencyVar  = document.getElementById('currencyVar');
      ...
      priceSlider.noUiSlider.on('update', function (values, handle) {
        var values = values.map(function (value) {
          return currencyVar.value + value;
        })
