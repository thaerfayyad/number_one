    ...
    <div class="page-sidebar-wrapper">
        <div class="page-sidebar navbar-collapse collapse">
            <ul class="page-sidebar-menu   " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                ...
                @endif
                @if(can('executive'))
                    <li class="nav-item {{(explode("/", request()->url())[5] == "executive") ? "active open" : ''}}">
                        <a href="{{url(getLocal().'/admin/executive')}}" class="nav-link nav-toggle">
                            <i class="fa fa-user"></i>
                            <span class="title">{{__('cp.executive')}}</span>
                ...
                @endif
                @if(can('employee'))
                    <li class="nav-item {{(explode("/", request()->url())[5] == "employee") ? "active open" : ''}}">
                        <a href="{{url(getLocal().'/admin/employee')}}" class="nav-link nav-toggle">
                            <i class="fa fa-users"></i>
                            <span class="title">{{__('cp.employee')}}</span>
                ...
                @endif
                @if(can('supplier'))
                    <li class="nav-item {{(explode("/", request()->url())[5] == "supplier") ? "active open" : ''}}">
                        <a href="{{url(getLocal().'/admin/supplier')}}" class="nav-link nav-toggle">
                            <i class="fa fa-users"></i>
                            <span class="title">{{__('cp.supplier')}}</span>
                ...
                @endif
                @if(can('Companies'))
                    <li class="nav-item {{(explode("/", request()->url())[5] == "Companies") ? "active open" : ''}} ">
                        <a href="{{url(getLocal().'/admin/companies')}}" class="nav-link nav-toggle">
                            <i class="fa fa-server"></i>
                            <span class="title">{{__('cp.companies')}}</span>
                        </a>
                    </li>
                @endif
                @if(can('calibers'))
                    <li class="nav-item {{(explode("/", request()->url())[5] == "calibers") ? "active open" : ''}} ">
                        <a href="{{url(getLocal().'/admin/calibers')}}" class="nav-link nav-toggle">
                            <i class="fa fa-sign-in"></i>
                            <span class="title">{{__('cp.calibers')}}</span>
                        </a>
                    </li>
                @endif
                @if(can('oils'))
                    <li class="nav-item {{(explode("/", request()->url())[5] == "oil") ? "active open" : ''}} ">
                        <a href="{{url(getLocal().'/admin/oils')}}" class="nav-link nav-toggle">
                            <i class="fa fa-sign-in"></i>
                            <span class="title">{{__('cp.oil')}}</span>
                        </a>
                    </li>
                @endif
                @if(can('size'))
                    <li class="nav-item {{(explode("/", request()->url())[5] == "oil") ? "active open" : ''}} ">
                        <a href="{{url(getLocal().'/admin/sizes')}}" class="nav-link nav-toggle">
                            <i class="fa fa-sign-in"></i>
                            <span class="title">{{__('cp.size')}}</span>
                        </a>
                    </li>
                @endif
                ...
                @if(can('orders'))
                    <li class="nav-item {{(explode("/", request()->url())[5] == "orders") ? "active open" : ''}} ">
                        <a href="{{url(getLocal().'/admin/inOrders')}}" class="nav-link nav-toggle">
                            <i class="fa fa-sign-in"></i>
                            <span class="title">{{__('cp.inOrders')}}</span>
                        </a>
                    </li>
                @endif

                @if(can('outOrders'))
                    <li class="nav-item {{(explode("/", request()->url())[5] == "outOrders") ? "active open" : ''}} ">
                        <a href="{{url(getLocal().'/admin/outOrders')}}" class="nav-link nav-toggle">
                            <i class="fa fa-sign-out"></i>
                            <span class="title">{{__('cp.outOrders')}}</span>
                        </a>
                    </li>
                @endif
                @if(can('debt'))
                    <li class="nav-item {{(explode("/", request()->url())[5] == "debt") ? "active open" : ''}} ">
                        <a href="{{url(getLocal().'/admin/debt')}}" class="nav-link nav-toggle">
                            <i class="fa fa-money"></i>
                            <span class="title">{{__('cp.debt')}}</span>
                        </a>
                    </li>
                @endif
                @if(can('rent'))
                    <li class="nav-item {{(explode("/", request()->url())[5] == "rent") ? "active open" : ''}} ">
                        <a href="{{url(getLocal().'/admin/rent')}}" class="nav-link nav-toggle">
                            <i class="fa fa-window-restore"></i>
                            <span class="title">{{__('cp.rent')}}</span>
                        </a>
                    </li>
                @endif
                @if(can('electricity'))
                    <li class="nav-item {{(explode("/", request()->url())[5] == "electricity") ? "active open" : ''}} ">
                        <a href="{{url(getLocal().'/admin/electricity')}}" class="nav-link nav-toggle">
                            <i class="fa fa-bolt"></i>
                            <span class="title">{{__('cp.electricity')}}</span>
                        </a>
                    </li>
                @endif
                @if(can('salary'))
                    <li class="nav-item {{(explode("/", request()->url())[5] == "salary") ? "active open" : ''}} ">
                        <a href="{{url(getLocal().'/admin/salary')}}" class="nav-link nav-toggle">
                            <i class="fa fa-money"></i>
                            <span class="title">{{__('cp.salary')}}</span>
                        </a>
                    </li>
                @endif
