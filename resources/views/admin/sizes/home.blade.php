        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-sm-9">
                        <div class="btn-group">
                            <a href="{{url(getLocal().'/admin/sizes/create')}}" style="margin-right: 5px"
...
{{--                        <td><img src="{{$one->image}}" width="50px" height="50px"></td>--}}
                        ...
                        <td>
                            <div class="btn-group btn-action">
                                <a href="{{url(getLocal().'/admin/size/'.$one->id.'/edit')}}"
...
@section('script')
    <script>
        function delete_adv(id, iss_id, e) {
            ...
            var url = '{{url(getLocal()."/admin/sizes")}}/' + id;
