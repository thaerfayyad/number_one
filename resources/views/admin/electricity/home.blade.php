...
@section('title') {{__('cp.electricity')}}
@endsection
@section('css')
@endsection
@section('content')
        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                ...
                <div class="box-filter-collapse">
                    ...
                    <form class="form-horizontal" method="get" action="{{url(getLocal().'/admin/electricity')}}">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-offset-3 col-md-9">
                                        ...
                                        <a href="{{url(app()->getLocale().'/admin/electricity')}}" type="submit"
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="toolsTable">
                    ...
                    <tr>
                        ...
                        <th> {{ucwords(__('cp.month'))}}</th>
                        <th> {{ucwords(__('cp.year'))}}</th>
                    ...
                    @forelse($items as $item)
                        <tr class="odd gradeX" id="tr-{{$item->id}}">
                            ...
                            <div class="btn-group btn-action">
                                ...
                                <a href="{{url(getLocal().'/admin/electricity/'.$item->id.'/edit')}}"
                                   class="btn btn-xs blue tooltips" data-container="body" data-placement="top"
                                   data-original-title="{{__('cp.edit')}}"><i class="fa fa-edit"></i>
                                </a>
                                
                                
                                <a href="#" onclick="openWindow('{{url(getLocal().'/admin/electricity/printOrder/'.$item->id)}}')" class="btn btn-xs blue tooltips" data-container="body" data-placement="top"
        ...
        @section('script')
            <script>
                function delete_adv(id, iss_id, e) {
                    ...
                    var url = '{{url(getLocal()."/admin/electricity")}}/' + id;
                ...
                function change_ordrSts(id, sts, e) {
                    ...
                    var url = '{{url(getLocal()."/admin/change_orders")}}/' + id;
                    var csrf_token = '{{csrf_token()}}';
                    $.ajax({
                        type: 'post',
                        headers: {'X-CSRF-TOKEN': csrf_token},
