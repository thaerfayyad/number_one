                        ...
                        <div class="form-body">
                            ...
                            <fieldset>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="name" class="form-control" vlaue="{{ old('name') }}" required>
                                    </div>
                                </div>
                            </fieldset>
                            ...
                            <fieldset>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="email" class="form-control" name="email" vlaue="{{ old('email') }}" required>
                                    </div>
                                </div>
                            </fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"
                                               type="text" class="form-control" name="mobile" value="{{ old('mobile') }}" required>
                                    </div>
                                </div>
                            </fieldset>
