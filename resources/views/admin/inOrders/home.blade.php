                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="toolsTable">
                    ...
                    @forelse($items as $item)
                        <tr class="odd gradeX" id="tr-{{$item->id}}">
                            ...
                            <td>{{$item->amount}}</td>
                            <td>{{$item->quantity}} X {{$item->price_one}} SR </td>
                            ...
                            <div class="btn-group btn-action">
                                ...
                                <a href="{{url(getLocal().'/admin/inOrders/'.$item->id.'/edit')}}"
                                   class="btn btn-xs blue tooltips" data-container="body" data-placement="top"
                                   data-original-title="{{__('cp.edit')}}"><i class="fa fa-edit"></i>
                                </a>
                                
                                
                                <a href="#" onclick="openWindow('{{url(getLocal().'/admin/inOrders/printOrder/'.$item->id)}}')" class="btn btn-xs blue tooltips" data-container="body" data-placement="top"
        ...
        @section('script')
            <script>
                function delete_adv(id, iss_id, e) {
                    ...
                    var url = '{{url(getLocal()."/admin/inorders")}}/' + id;
