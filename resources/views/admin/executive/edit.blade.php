            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase"executive
                              style="color: #e02222 !important;">{{__('cp.edit')}} {{__('cp.executive')}}</span>
                    </div>
                </div>
                <div class="portlet-body form">
                    <form method="post" action="{{route('admin.executive.update',$item->id)}}"
                        ...
                        <div class="form-actions">
                            <div class="row">
                                <div class="col-md-offset-3 col-md-9">
                                    ...
                                    <a href="{{url(getLocal().'/admin/executive')}}" class="btn default">{{__('cp.cancel')}}</a>
                                </div>
                            </div>
                        </div>
