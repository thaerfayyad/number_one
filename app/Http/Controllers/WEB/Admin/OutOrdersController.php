...
class OutOrdersController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $items = $items->where('type',1)->whereIn('category_id', [4,5,6,7,8,11])->orderBy('id', 'desc')->get();


        return view('admin.outOrders.home', [
            'items' => $items,
            'locales' => $locales,
        ]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.outOrders.edit', [
            'order' => $order]);
    }
    ...
    public function printOrder($id)
    {
        ...
        return view('admin.outOrders.invoice', [
            'order' => $order ]);
    }
